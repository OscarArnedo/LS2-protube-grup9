...
public class CommentController {
    ...
    public CommentDTO updateComment(@PathVariable Long commentId, @RequestBody String text) throws Exception {
        JSONObject jsonObject = new JSONObject(text);
        return commentService.updateComment(commentId, jsonObject.getString("text"));
    }
